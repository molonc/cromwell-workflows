...
task Merge1 {
    ...
    command <<<
        ...
        SURVIVOR merge inputs.txt 100 1 1 1 0 30 ~{tumor_name + "_merged1.vcf"}
    >>>
    ...
    output {
        File outfile = '~{tumor_name + "_merged1.vcf"}'
    }
}
...
task Merge2 {
    ...
    command <<<
        ...
        SURVIVOR merge inputs.txt 100 2 1 1 0 30 ~{tumor_name + "_merged2.vcf"}
    >>>
    ...
    output {
        File outfile = '~{tumor_name + "_merged2.vcf"}'
    }
}
...
task Merge3 {
    ...
    command <<<
        ...
        SURVIVOR merge inputs.txt 100 3 1 1 0 30 ~{tumor_name + "_merged3.vcf"}
    >>>
    ...
    output {
        File outfile = '~{tumor_name + "_merged3.vcf"}'
    }
}
