...
task MarkDuplicates {
  ...
  Int disk_size = ceil(md_disk_multiplier * total_input_size) + additional_disk # increase additional_disk = 20 -> 40 

  Float memory_size = 8.5 * memory_multiplier # 7.5 * memory_multiplier -> 8.5 * memory_multiplier 
...
task CheckContamination {
  ...
  Int disk_size = ceil(size(input_bam, "GB") + size(ref_fasta, "GB")) + 60 # instead of + 30 -> + 60 
