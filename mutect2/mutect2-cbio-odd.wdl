...
workflow Mutect2 {
    ...
    Runtime standard_runtime = {"gatk_docker": gatk_docker, "gatk_override": gatk_override,
            ...
            "machine_mem": small_task_mem * 2500, "command_mem": small_task_mem * 2500 - 500,
...
task M2 {
    ...
    Int machine_mem = if defined(mem) then mem * 2000 else 16384 # used to be: if defined(mem) then mem * 1000 else 3500
    ...
    runtime {
        ...
        disk: select_first([disk_space, 700]) + " GB" # select_first([disk_space, 100]) + " GB"
        preemptible: true
        maxRetries: select_first([max_retries, 0])
        cpu: select_first([cpu, 12]) # select_first([cpu, 1])
    }
