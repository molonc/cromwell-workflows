...
task Merge1 {
    ...
    command <<<
        ...
        SURVIVOR merge inputs.txt 100 1 0 1 1 30 ~{tumor_name + "_" + normal_name + "_merged1-no-ViolaL.vcf"}
    >>>
    ...
    output {
        File outfile = '~{tumor_name + "_" + normal_name + "_merged1-no-ViolaL.vcf"}'
    }
}
...
task Merge2 {
    ...
    command <<<
        ...
        SURVIVOR merge inputs.txt 100 2 0 1 1 30 ~{tumor_name + "_" + normal_name + "_merged2-no-ViolaL.vcf"}
    >>>
    ...
    output {
        File outfile = '~{tumor_name + "_" + normal_name + "_merged2-no-ViolaL.vcf"}'
    }
}
...
task Merge3 {
    ...
    command <<<
        ...
        SURVIVOR merge inputs.txt 100 3 0 1 1 30 ~{tumor_name + "_" + normal_name + "_merged3-no-ViolaL.vcf"}
    >>>
    ...
    output {
        File outfile = '~{tumor_name + "_" + normal_name + "_merged3-no-ViolaL.vcf"}'
    }
}
