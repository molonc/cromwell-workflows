...
task MarkDuplicates {
  ...
  Int disk_size = ceil(md_disk_multiplier * total_input_size) + additional_disk + 20 # added 20 

  Float memory_size = (7.5 * memory_multiplier) + 20  # previously: 7.5 * memory_multiplier
